...
async function animateDice(roll) {
  ...
  // Mantemos a lógica do exemplo standalone: o dado sempre para
  // exatamente na face sorteada, sem acumular drift entre jogadas.
  const targetX = face.x + extraX;
  const targetY = face.y + extraY;
  ...
  subtitle.textContent = "Agora você pode fechar esta janela para responder à pergunta.";
